...
public interface IUserInfoService {
	...
	BusinessUserInfo getBusinessUserInfoByUsername(String userName);

	boolean updateUserBalanceById(Integer id, Integer balance);

	List<BusinessUserInfo> getBusinessUserListInfo(Integer start, Integer end, Integer status);

	boolean updateStatusInfoById(Long id, Integer status,String userName);

	BusinessUserInfo getBusinessUserInfoById(Integer id);
